...
- [x] **Base Endpoint URL & Form Ergonomics Streamlining**: Positioned Base Endpoint URL directly below API Key field with auto-fill provider defaults; removed collapsible "Advanced Settings" toggle so all metadata fields render continuously inline in main form without data schema breakage.
