...
- [x] **Base Endpoint URL & Collapsible Advanced Settings**: Positioned Base Endpoint URL directly below API Key field with auto-fill provider defaults; restored collapsible "Advanced Settings" toggle for secondary metadata fields (Org ID, Tags, Notes, Rotation Interval).
