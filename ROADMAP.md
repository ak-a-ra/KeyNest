...
- [ ] **Google Keep 1-Tap Grid / List Toggle**: Seamless dynamic switching between 2-column staggered masonry and single-column detailed list feeds, with persisted layout preference in encrypted settings.
