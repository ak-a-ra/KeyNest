...
object ProviderPresets {
    val list = listOf(
        ProviderPreset(
            ...
            category = "AI & LLMs",
            defaultPrefix = "sk-",
            placeholderKey = "sk-proj-abc123456789...",
        ...
        ProviderPreset(
            ...
            category = "Dev Tools",
            defaultPrefix = "ghp_",
            placeholderKey = "ghp_abc123456789...",
        ...
        ProviderPreset(
            ...
            category = "Payments",
            defaultPrefix = "sk_",
            placeholderKey = "sk_live_51... or sk_test_51...",
        ...
        ProviderPreset(
            ...
            category = "Auth & DB",
            defaultPrefix = "sbp_",
            placeholderKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...",
    ...
    fun detectProvider(key: String): String {
        return com.example.data.security.VaultSecurity.detectProviderFromKey(key)
    }
