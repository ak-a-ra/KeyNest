...
- `app/src/main/java/com/example/core/security/`: Keystore cryptography, encrypted preferences, and backup crypto (`SecretCipher`/`KeystoreCipher`, `VaultSecurity`, `VaultBackupCrypto`).
